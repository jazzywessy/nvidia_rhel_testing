...
class HTMLPage(object):
    ...
    def __init__(self, tables=[], firstpara="",lastpara="",css=None, encoding="utf-8"):
    ...
    def add_firstpara(self, para):
        self.firstpara = para
#         self.firstpara.append(para)
        
    def add_lastpara(self, para):
        self.lastpara = para
#         self.lastpara.append(para)
...
if __name__ == "__main__":
    ...
    """
    table1 = SimpleTable([['Hello,', 'world!'], ['How', 'are']],
            header_row=['Header1', 'Header2'],
            css_class='mytable')

    page = HTMLPage()
    page.add_table(table1)
    page.add_firstpara('<p>hi</p>')
    page.add_lastpara('<p>hi</p>')
#     page.add_tag("<p>hi</p>")
    page.css = css
    page.save("test.html")
